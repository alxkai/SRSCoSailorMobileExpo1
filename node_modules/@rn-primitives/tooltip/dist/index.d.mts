export * from './tooltip';
import { SlottableViewProps, ForceMountable, SlottablePressableProps, PositionedContentProps, ViewRef, PressableRef } from '@rn-primitives/types';
...
type ContentProps = SlottableViewProps & Omit<PositionedContentProps, 'side'> & {
    /**
