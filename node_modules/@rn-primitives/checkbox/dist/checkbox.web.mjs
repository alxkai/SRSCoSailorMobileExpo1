...
var Root2 = React.forwardRef(
  ({ asChild, disabled, checked, onCheckedChange, onPress: onPressProp, role: _role, ...props }, ref) => {
    ...
    return <CheckboxContext.Provider value={{ checked, disabled, onCheckedChange }}><Checkbox.Root
      checked={checked}
...
var Indicator2 = React.forwardRef(
  ({ asChild, forceMount, ...props }, ref) => {
    ...
    return <Checkbox.Indicator forceMount={forceMount} asChild><Component ref={ref} {...props} /></Checkbox.Indicator>;
  }
);
