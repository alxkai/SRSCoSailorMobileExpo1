export * from './label';
import { SlottablePressableProps, SlottableTextProps, PressableRef } from '@rn-primitives/types';
export { TextRef } from '@rn-primitives/types';
...
export type { RootProps, RootRef, TextProps };
