...
var radio_group_web_exports = {};
__export(radio_group_web_exports, {
  Indicator: () => Indicator2,
  Item: () => Item2,
  Root: () => Root2
});
module.exports = __toCommonJS(radio_group_web_exports);
...
var Root2 = React.forwardRef(
  ({ asChild, value, onValueChange, disabled = false, ...viewProps }, ref) => {
    ...
    ><RadioGroup.Root value={value} onValueChange={onValueChange} disabled={disabled} asChild><Component ref={ref} {...viewProps} /></RadioGroup.Root></RadioGroupContext.Provider>;
  }
);
...
var Item2 = React.forwardRef(
  ({ asChild, value, onPress: onPressProps, ...props }, ref) => {
    ...
    return <RadioGroup.Item value={value} asChild><Component ref={ref} onPress={onPress} {...props} /></RadioGroup.Item>;
  }
);
...
var Indicator2 = React.forwardRef(
  ({ asChild, forceMount, ...props }, ref) => {
    const Component = asChild ? Slot.View : import_react_native.View;
    return <RadioGroup.Indicator asChild><Component ref={ref} {...props} /></RadioGroup.Indicator>;
  }
);
