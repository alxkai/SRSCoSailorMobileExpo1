...
var Root2 = React.forwardRef(
  ({ asChild, onOpenChange: onOpenChangeProp, ...viewProps }, ref) => {
    ...
    return <ContextMenuContext.Provider value={{ open, onOpenChange }}><ContextMenu.Root onOpenChange={onOpenChange}><Component ref={ref} {...viewProps} /></ContextMenu.Root></ContextMenuContext.Provider>;
  }
);
...
var Trigger2 = React.forwardRef(
  ({ asChild, disabled = false, ...props }, ref) => {
    ...
    return <ContextMenu.Trigger disabled={disabled ?? void 0} asChild><Component ref={augmentedRef} disabled={disabled} {...props} /></ContextMenu.Trigger>;
  }
);
...
var Content2 = React.forwardRef(
  ({
    ...
    const Component = asChild ? Slot.View : import_react_native.View;
    return <ContextMenuContentContext.Provider value={{ close }}><ContextMenu.Content
    ...
    ><Component ref={ref} {...props} /><ContextMenu.Item
      ref={itemRef}
      aria-hidden
      ...
      tabIndex={-1}
      hidden
    /></ContextMenu.Content></ContextMenuContentContext.Provider>;
  }
);
...
var Item2 = React.forwardRef(
  ({ asChild, textValue, closeOnPress = true, onPress: onPressProp, ...props }, ref) => {
    ...
    return <ContextMenu.Item
      ...
      asChild
    ><Component ref={ref} role='button' onPress={onPress} onKeyDown={onKeyDown} {...props} /></ContextMenu.Item>;
  }
);
Item2.displayName = "ItemWebContextMenu";
var Group2 = React.forwardRef(({ asChild, ...props }, ref) => {
  const Component = asChild ? Slot.View : import_react_native.View;
  return <ContextMenu.Group asChild><Component ref={ref} {...props} /></ContextMenu.Group>;
});
...
var Label2 = React.forwardRef(({ asChild, ...props }, ref) => {
  ...
  return <ContextMenu.Label asChild><Component ref={ref} {...props} /></ContextMenu.Label>;
});
...
var RadioGroup2 = React.forwardRef(
  ({ asChild, value, onValueChange, ...props }, ref) => {
    const Component = asChild ? Slot.View : import_react_native.View;
    return <ContextMenuRadioGroupContext.Provider value={{ value, onValueChange }}><ContextMenu.RadioGroup value={value} onValueChange={onValueChange} asChild><Component ref={ref} {...props} /></ContextMenu.RadioGroup></ContextMenuRadioGroupContext.Provider>;
  }
);
...
var ItemIndicator2 = React.forwardRef(
  ({ asChild, forceMount, ...props }, ref) => {
    const Component = asChild ? Slot.View : import_react_native.View;
    return <ContextMenu.ItemIndicator forceMount={forceMount} asChild><Component ref={ref} {...props} /></ContextMenu.ItemIndicator>;
  }
);
...
var Separator2 = React.forwardRef(
  ({ asChild, decorative, ...props }, ref) => {
    const Component = asChild ? Slot.View : import_react_native.View;
    return <ContextMenu.Separator asChild><Component ref={ref} {...props} /></ContextMenu.Separator>;
  }
);
...
var Sub2 = React.forwardRef(
  ({ asChild, defaultOpen, open: openProp, onOpenChange: onOpenChangeProp, ...props }, ref) => {
    ...
    const Component = asChild ? Slot.View : import_react_native.View;
    return <ContextMenuSubContext.Provider value={{ open, onOpenChange }}><ContextMenu.Sub open={open} onOpenChange={onOpenChange}><Component ref={ref} {...props} /></ContextMenu.Sub></ContextMenuSubContext.Provider>;
  }
);
...
var SubTrigger2 = React.forwardRef(
  ({ asChild, textValue, disabled = false, onPress: onPressProp, ...props }, ref) => {
    ...
    const Component = asChild ? Slot.Pressable : import_react_native.Pressable;
    return <ContextMenu.SubTrigger disabled={disabled ?? void 0} textValue={textValue} asChild><Component ref={ref} onPress={onPress} {...props} /></ContextMenu.SubTrigger>;
  }
);
...
var SubContent2 = React.forwardRef(
  ({ asChild = false, forceMount, ...props }, ref) => {
    const Component = asChild ? Slot.Pressable : import_react_native.Pressable;
    return <ContextMenu.Portal><ContextMenu.SubContent forceMount={forceMount}><Component ref={ref} {...props} /></ContextMenu.SubContent></ContextMenu.Portal>;
  }
);
Content2.displayName = "ContentWebContextMenu";
