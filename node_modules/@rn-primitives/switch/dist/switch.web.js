...
var Root2 = React.forwardRef(
  ({
    ...
    return <Switch.Root checked={checked} onCheckedChange={onCheckedChange} disabled={disabled} asChild><Component
      ref={ref}
      disabled={disabled}
      onPress={onPress}
      onKeyDown={onKeyDown}
...
var Thumb2 = React.forwardRef(({ asChild, ...props }, ref) => {
  ...
  return <Switch.Thumb asChild><Component ref={ref} {...props} /></Switch.Thumb>;
});
