...
import { MenuProps, PortalProps, RootProps } from './index.mjs';
import './menubar';
...
declare function useRootContext(): IMenuContext;
declare const Menu: React.ForwardRefExoticComponent<react_native.ViewProps & {
    asChild?: boolean;
} & {
    value: string | undefined;
} & React.RefAttributes<View>>;
declare function useMenuContext(): MenuProps;
...
declare const SubContent: React.ForwardRefExoticComponent<react_native.ViewProps & {
    asChild?: boolean;
} & _rn_primitives_types.ForceMountable & React.RefAttributes<View>>;
