...
var Root = React.forwardRef(
  ({ asChild, open: openProp, defaultOpen, onOpenChange: onOpenChangeProp, ...viewProps }, ref) => {
    ...
    ><Component ref={ref} {...viewProps} /></AlertDialogContext.Provider>;
  }
);
...
function Portal({ forceMount, hostName, children }) {
  ...
  return <import_portal.Portal hostName={hostName} name={`${value.nativeID}_portal`}><AlertDialogContext.Provider value={value}>{children}</AlertDialogContext.Provider></import_portal.Portal>;
}
