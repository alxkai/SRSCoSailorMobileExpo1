...
import { HStack } from "~/components/ui/gluestack/hstack";
import { isWeb } from "@gluestack-ui/nativewind-utils/IsWeb";
import { Icon } from "~/components/ui/gluestack/icon";
import { Text } from "~/components/ui/gluestack/text";
import { VStack } from "~/components/ui/gluestack/vstack";
import { Pressable } from "~/components/ui/gluestack/pressable";
import { Button, ButtonText } from "~/components/ui/gluestack/button";
import { useEffect, useState } from "react";
import { Heading } from "~/components/ui/gluestack/heading";
import { ScrollView } from "~/components/ui/gluestack/scroll-view";
import { Divider } from "~/components/ui/gluestack/divider";
import { Grid, GridItem } from "~/components/ui/gluestack/grid";
import {
  Avatar,
  AvatarFallbackText,
  AvatarImage,
} from "~/components/ui/gluestack/avatar";
import { useRouter } from "@unitools/router";
import { SafeAreaView } from "~/components/ui/gluestack/safe-area-view";
import { cn } from "@gluestack-ui/nativewind-utils/cn";
import { Platform } from "react-native";
import type { LucideIcon } from "lucide-react";
import { Home as HomeIcon, Inbox as InboxIcon, Globe as GlobeIcon, Heart as HeartIcon, User as ProfileIcon, Menu, ChevronLeft, Calendar } from "lucide-react";
  ...
  return (
    <HStack className="pt-4  pr-10 pb-3 bg-background-0 items-center justify-between border-b border-border-300">
      <HStack className="items-center">
        ...
        >
          <Icon as={Menu} size="lg" className="mx-5" />
        </Pressable>
